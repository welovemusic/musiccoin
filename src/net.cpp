...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Musiccoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"armor.ignorelist.com", "dnsseed.armor.ignorelist.com"},
	{"gmc-server.de", "gmc-server.de"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"armor.ignorelist.com", "testnet-armor.ignorelist.com"},
	{"gmc-server.de", "gmc-server.de"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Musiccoin is probably already running."), addrBind.ToString().c_str());
        else
